...
import (
	...
	"github.com/ethercore/go-ethercore/consensus/misc"
...
var (
	...
	EtherCoreBlockReward      = big.NewInt(1e+18) // Block reward in wei for successfully mining a block upward for EtherCore
...
// calcDifficultyBombDisposal creates a difficultyCalculator with the given bomb-delay.
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	if config.IsEtherCore(header.Number) {
		blockReward = EtherCoreBlockReward
	}
