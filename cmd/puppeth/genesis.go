...
import (
	...
	math2 "github.com/ethercore/go-ethercore/common/math"
...
type alethGenesisSpec struct {
	...
	Params     struct {
		...
		ProgpowForkBlock           *hexutil.Big           `json:"progpowForkBlock,omitempty"`
...
func (spec *parityChainSpec) setProgpow(num *big.Int) {
	spec.Engine.Ethash.Params.ProgpowTransition = hexutil.Uint64(num.Uint64())
}
