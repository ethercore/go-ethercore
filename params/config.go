...
var (
	...
	EtherCoreGenesisHash     = common.HexToHash("0x2b9e5f32b27e1a96083bae3e02918d83e190a6b2a866266b942ccfb5dbdc4e99")
	EtherCorePoAGenesisHash  = common.HexToHash("0x89f2302f4abd45be33d1af495a93a358e6f715fda798e623fe263fd557905cf1")
...
var (
	...
	EtherCoreChainConfig = &ChainConfig{
		...
		DAOForkSupport:      true,
		EIP150Block:         big.NewInt(0),
		EIP150Hash:          common.HexToHash("0x2b9e5f32b27e1a96083bae3e02918d83e190a6b2a866266b942ccfb5dbdc4e99"),
		EIP155Block:         big.NewInt(0),
		EIP158Block:         big.NewInt(0),
		ByzantiumBlock:      big.NewInt(0),
		ConstantinopleBlock: big.NewInt(0),
		...
		ProgpowBlock:        big.NewInt(0),
		EtherCoreBlock:      big.NewInt(0),
		ECIP1017EraRounds:   big.NewInt(100000000),
		Ethash:              new(EthashConfig),
	}
	...
	EtherCorePoAChainConfig = &ChainConfig{
		...
		DAOForkSupport:      true,
		EIP150Block:         big.NewInt(0),
		EIP150Hash:          common.HexToHash("0x89f2302f4abd45be33d1af495a93a358e6f715fda798e623fe263fd557905cf1"),
		EIP155Block:         big.NewInt(0),
		EIP158Block:         big.NewInt(0),
		ByzantiumBlock:      big.NewInt(0),
		ConstantinopleBlock: big.NewInt(0),
	...
	EtherCoreTestChainConfig = &ChainConfig{
		...
		DAOForkSupport:      true,
		EIP150Block:         big.NewInt(0),
		EIP150Hash:          common.HexToHash("0x1701803e3dbffe0abd7c7d9d0c703f369c2783c0b4f7981baf9e0c538764b071"),
		EIP155Block:         big.NewInt(0),
		EIP158Block:         big.NewInt(0),
		ByzantiumBlock:      big.NewInt(0),
		ConstantinopleBlock: big.NewInt(0),
...
type ChainConfig struct {
	...
	EtherCoreBlock    *big.Int `json:"ethercoreBlock,omitempty"`    // EtherCore switch block (nil = not active, 0 = already activated)
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v Petersburg: %v Istanbul: %v Muir Glacier: %v Progpow: %v EtherCore: %v Halving Block: %v Engine: %v}",
		c.ChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
// IsEtherCore returns whether num is either equal to the EtherCore fork block or greater.
func (c *ChainConfig) IsEtherCore(num *big.Int) bool {
	return isForked(c.EtherCoreBlock, num)
}
...
type Rules struct {
	...
	IsByzantium, IsConstantinople, IsPetersburg, IsIstanbul, IsEtherCore bool
}
